...
func main() {
	var accessToken = "c3df076e5dcdef75aa569ea8260e481c4f1182a2"
	...
	upload, err := service.
		Create(strava.FileDataTypes.GPX, "exercise-2015-3-29.gpx", strings.NewReader("exercise-2015-3-29.gpx")).
		Private().
		Do()
